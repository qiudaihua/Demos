...
public class RadialPercentage0 extends View {
    ...
    public RadialPercentage0(Context context) {
        this(context, null);
    }

    public RadialPercentage0(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RadialPercentage0(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float percent = 100 * progress / max; //中间的进度百分比，先转换成float在进行除法运算，不然都为0  
        float textWidth = paint.measureText(percent + "%"); //测量字体宽度，我们需要根据字体的宽度设置在圆环中间  
        Log.d("daiq", "textWidth=" + textWidth);
